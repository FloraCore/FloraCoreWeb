<template>
  <div class="add-node">
    <form autocomplete="off" class="row" @submit.prevent>
      <div v-if="!selectedNodes.length" class="form-group">
      ...
      <div v-else class="form-group bulk-edit">
        <p>
          ...
          <button :title="$t('editor.nodes.deselect')" @click="deselectNodes">
      ...
      <div class="form-group contexts">
        ...
        <div v-else class="bulk-contexts">
        ...
        <div>
          <code v-for="(entry, index) in flattenedContexts"
                :key="`add_node_context_${entry.key}_${entry.value}_${index}`">
            <span>{{ entry.key }}:</span>
            {{ entry.value }}
          </code>
        </div>
      ...
      <div v-if="context.ui" v-click-outside="closeContextUi" class="context-ui">
        ...
        <ul>
          <li v-for="(entry, index) in flattenedContexts"
              :key="`add_node_flattened_context_${entry.key}_${entry.value}_${index}`">
